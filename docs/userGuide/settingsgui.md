...
### Configuring the System API Key
...
3.  Enter a strong, secret value in the **API Key** field.
4.  Click **Save Settings**.

**Security Behavior:**
*   **Unsecured Mode**: If the API Key field is empty (and no environment variables are set), Compileo allows all requests.
